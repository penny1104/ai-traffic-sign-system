...
本專案為基於 樹莓派（Raspberry Pi）自走車系統，結合 卷積神經網路（CNN） 與 超音波感測技術，實現交通號誌辨識與即時避障控制，模擬自動駕駛中的：

感知 → 判斷 → 行動（Perception → Decision → Control）

🎯 專案目標

建立一套具備以下能力的嵌入式 AI 系統：
